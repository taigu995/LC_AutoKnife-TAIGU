...
### 修复
- 将 `HarmonyPrefix` 改为 `HarmonyPostfix`（与原始模组一致）
...
### 功能
- 合并 AutoKnifeAttack v1.0.0 (Yan01h) 和 FastKnife v0.0.3 (nexor) 的功能
- 署名 TAIGU
- 目标适配 Lethal Company V81
